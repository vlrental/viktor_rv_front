...
PUBLIC_ROUTES = (
    ...
    SeoRoute(
        ...
        "Reserve a waterfront campsite on Osoyoos Lake, then request final route approval for delivery and setup at this outer-range destination.",
    ...
    SeoRoute(
        ...
        "Enjoy a family campground at Shuswap Lake with your RV transported, positioned and prepared at the reserved site.",
    ...
    SeoRoute(
        ...
        "Book a Shuswap Lake campsite near Tappen and arrive to a VL Rental RV delivered and set up for your stay.",
