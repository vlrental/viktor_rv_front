...
const TERM_SECTIONS: &[TermSection] = &[
    ...
    TermSection {
        ...
        paragraphs: &[
            "The customer must review the supplied inventory and promptly report a missing, damaged, or malfunctioning item. Basic kitchen equipment includes a toaster, coffee maker, kettle, stove, microwave, refrigerator, freezer, dishes, cutlery, pots, pans, and basic cooking utensils. Bedding sets cost CA$40 per selected bed, with one to four sets available per booking. A portable BBQ is a paid extra. Shower towels are not supplied.",
